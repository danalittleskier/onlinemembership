...
public class ExtrasBean
{
	...
	public void setAlpineOption(String alpineOption)
	{
		this.alpineOption = alpineOption;
	}

	public String getAlpineQty()
	{
		return alpineQty;
	}
	...
	public void setFreestyleOption(String freestyleOption)
	{
		this.freestyleOption = freestyleOption;
	}

	public String getFreestyleQty()
	{
		return freestyleQty;
	}

	public void setFreestyleQty(String freestyleQty)
	{
	...
	public void setCrossCountryOption(String crossCountryOption)
	{
		this.crossCountryOption = crossCountryOption;
	}

	public String getCrossCountryQty()
	{
		return crossCountryQty;
	}
	...
	{
		return jumpingOption;
	}

	public void setJumpingOption(String jumpingOption)
	{
		this.jumpingOption = jumpingOption;
	}

	public String getJumpingQty()
	{
		return jumpingQty;
	}

	public void setJumpingQty(String jumpingQty)
	{
	...
	public void setGeneralQty(String generalQty)
	{
