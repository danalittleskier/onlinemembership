...
*Physical contact is recommended only in support of the following purposes:<br>
 -To develop or demonstrate sports skills. <br>
 -To diagnose or treat an injury. <br>
 -To give appropriate sport massage.<br>
*These actions should only be carried out by appropriately qualified staff.<br>
...
faith, and treat officials and other competitors with respect. <br>
...
*Is usually repeated over a period of time. <br>
...
*Watch for signs of abuse, and of bullying. <br>
...
*However, if you suspect abuse, you should take action. Report your concerns to parents, or if necessary, local child protection or law enforcement
authorities. <br>
...
<c:if test="${accountBean.parentInfoRequired}">
	...
	<table width="100%">
		<tr>
			...
			<td><span style="float:left;">* I, &nbsp;</span><form:input path="memberLegal.safeSportGuardianName" cssStyle="float:left;"/><span style="float:left;">, CERTIFY AS PARENT OR GUARDIAN OF THE MEMBER INDICATED to the waiver as noted above.</span></td>
		</tr>
	</table>
	<script type="text/javascript" defer="defer">
