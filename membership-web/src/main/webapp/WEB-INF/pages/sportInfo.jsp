...
<body>
	...
	<div id="div0">
		...
		<p><em>Note: Alpine Competitors 18 &amp; older may race in Alpine Masters races (excluding championships).</em></p>
		...
		<p>Failure to register within 30 days of processing will result in inactivation of membership. <strong>A $25 fee will be required for reactivation.</strong></p>
	...
	<div id="div2">
		...
		<p><em>Note: Does not include participation in USSA Cross Country Ranking List. Receives limited issues of Ski Racing magazine.  </em></p>
		...
		<p><em>Note: Required for access to coaching credentials at all USSA competitions.  Issuance of credentials to appropriate working coaches is the responsibility of the event. </em></p>
		<p><strong>Disabled Coach: </strong>Includes both USSA Disabled Cross Country Coach and Cross Country Official memberships including access to USSA coaches programs, clinics, certification programs and educational materials. </p>
		<p><em>Note: Required for access to coaching credentials at all USSA competitions. Issuance of credentials to appropriate working coaches is the responsibility of the event.</em></p> 
		<h3>Attention Coaches and Officials</h3>
		<p>All Coaches and Officials are required to undergo periodic background screening.</p>
		<p>If screening is required, you must register within 30 days of processing. <strong> Instructions may be found on our website at <a href="http://www.ussa.org">ussa.org,</a> membership tools, online instructions.</strong></p>
