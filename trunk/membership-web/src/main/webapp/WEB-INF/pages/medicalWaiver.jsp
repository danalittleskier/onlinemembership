...
<!--Fax to: (435) 647-2052                        UNITED STATES SKI & SNOWBOARD ASSOCIATION                                  2008-09-->
Primary Medical Insurance Exception Agreement<br/>
THIS IS A WAIVER OF CERTAIN LEGAL RIGHTS. PLEASE READ CAREFULLY BEFORE SIGNING.<br/><br/>

	This Agreement is made and entered into on the date set forth below by and between the undersigned member (hereinafter "Member") for and in favor or the United States Ski and Snowboard Association, its officers, directors, employees, coaches, trainers, contractors, volunteers, members or other representatives (hereinafter collectively "USSA").<br/>
	WHEREAS, Member desires to participate in USSA training, competition or activities related to USSA sanctioned, sponsored or conducted competitions; and
	WHEREAS, all members of USSA are required independently to obtain and maintain throughout the course of their membership in USSA primary medical and accident insurance prior to participating in any training, competition or activities related to USSA sanctioned, sponsored or conducted competitions; and
	WHEREAS, notwithstanding the foregoing policy pertaining to medical and accident insurance, Member has represented to USSA the existence of special circumstances under which Member seeks to be excused from the requirement to obtain such medical and accident insurance; and
...
1. Member understands and agrees that by participating in any type or form of USSA training, competition or
...
5. In the event that any provision herein, or any other contract between Member and USSA, which was intended to exculpate USSA
 from any liability is found by any court to be unenforceable for any reason, Member hereby agrees to DEFEND, INDEMNIFY, AND HOLD HARMLESS USSA from any and all liability arising from participation in any USSA activity.<br/><br/>

By checking the box below, MEMBER CERTIFIES THAT HE/SHE HAS READ AND UNDERSTOOD THIS AGREEMENT, and agrees in full with its terms, intend that it be binding on Member, his/her heirs, executors, administrators and assigns, and that it remain in full force and effect for as long as Member participates in USSA training, competition and related programs and activities without independent medical and accident insurance.<br/><br/>

THIS DOCUMENT DEPRIVES YOU OF ANY LEGAL RIGHT TO SUE USSA, EVEN FOR ITS OWN NEGLIGENCE.  DO NOT SIGN AND INITIAL IT UNLESS YOU HAVE READ IT IN ITS ENTIRETY.  SEEK THE ADVICE OF LEGAL COUNSEL IF YOU ARE UNSURE OF ITS EFFECT.<br/><br/>


Add checkbox:  I agree to the terms defined
<%--
					<form:hidden id="privateAddress" path="member.privateAddress"/>
					<input id="medicalWaiver" type="checkbox" onclick="updateCheckboxHidden('privateAddress', this)"/>
--%>
