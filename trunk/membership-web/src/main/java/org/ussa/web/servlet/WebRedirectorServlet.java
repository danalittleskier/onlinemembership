...
import org.ussa.web.filter.SessionMonitorFilter;
 ...
 */
public class WebRedirectorServlet extends HttpServlet {
	
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
			throws ServletException, IOException {
		
		if (req.getSession().getAttribute(SessionMonitorFilter.SAVED_URI_KEY) != null) {
			// redirect to *original* URL
			String uri = (String)req.getSession().getAttribute(SessionMonitorFilter.SAVED_URI_KEY);
			String queryParams = (String)req.getSession().getAttribute(SessionMonitorFilter.SAVED_QUERY_STRING_KEY);
			...
			req.getSession().setAttribute(SessionMonitorFilter.SAVED_URI_KEY, null);
			req.getSession().setAttribute(SessionMonitorFilter.SAVED_QUERY_STRING_KEY, null);
