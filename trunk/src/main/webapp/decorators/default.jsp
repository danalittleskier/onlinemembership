...
<head>
	...
	<title><decorator:title default="U.S. Ski & Snowboard Membership Registration"/></title>
...
<body>
	<!--Start: page-wrapper --><div id="page-wrapper">
        ...
        <!--Start: page --><div id="page">
                  ...
                  <!--Start: Logo --><div id="MainLogoUSSA"> <a href="http://ussa.org" target="_blank"><img src="./styles/images/logos/USSkiTeamLogo.png" width="88"></a>
                  <!--End: Logo --></div>
                  ...
                  <!--End: Navbar --></div>
  <div style="position:absolute;top:130px;right:44px;"><a href="http://my.ussa.org" target="_blank">Return to My Account</a></div>
